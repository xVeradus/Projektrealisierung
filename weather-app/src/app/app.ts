...
/**
 * Main entry point component of the Angular application.
 * Handles the initial startup logic, including checking backend connectivity
 * and displaying the global loading overlay.
 */
@Component({
  selector: 'app-root',
...
export class App implements OnInit {
  ...
  /**
   * Initiates the backend connectivity check and displays the initial loading screen.
   */
  ...
  /**
   * Recursively polls the backend `/api/ready` endpoint until the database
